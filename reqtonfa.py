...
for i in range(len(nfa['transition_function'])):
	print(nfa['transition_function'][i])
print('Start State: ',nfa["initial_state"])
print("End State: ",nfa["final_states"])

# visual_utils_class = visual_utils
# visual_utils_class.draw_nfa(nfa)